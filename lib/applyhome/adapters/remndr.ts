...
function buildReceipt(raw: RemndrDetailRaw): ReceiptWindow[] {
...
function toNotice(rawInput: unknown): Notice {
  const raw = rawInput as RemndrDetailRaw
...
export const remndrAdapter: NoticeAdapter = {
  detailOperation: 'getRemndrLttotPblancDetail',
  mdlOperation: 'getRemndrLttotPblancMdl',
  dateFormat: 'iso',
  areaKind: 'supply',
